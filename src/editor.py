...
def add_output_mp3_audio_to_output_old_mp4():
    os.system("ffmpeg -i output_old.mp4 -i output.mp3 -c copy -map 0:v:0 -map 1:a:0 output2.mp4")
    ...
    os.system("ffmpeg -i output2.mp4 -i file1.mp3 -i file2.mp3 -c:v copy -map 0:v -map 1:a:0 -map 2:a:0 -y output.mp4")
