...
def add_output_mp3_audio_to_output_old_mp4():
    ...
    os.system("ffmpeg -i file1.mp3 -i output.mp3 -filter_complex amerge=inputs=2 -ac 2 output2.mp3")
    os.system("ffmpeg -i output_old.mp4 -i output2.mp3 -c copy -map 0:v:0 -map 1:a:0 output1.mp4")   
